...
#define _L_TO_LC(l) L_TO_LEFT_COUNT[l]
#define _XY_TO_LC(x, y) XY_TO_LEFT_COUNT[x][y]
#define _generLC(_1, _2, __, ...) __
#define getLeftCount(...) INDIRECT_EXPAND(_generLC, (__VA_ARGS__, _XY_TO_LC, _L_TO_LC, ...)(__VA_ARGS__))

#define _R_TO_RC(r) R_TO_RIGHT_COUNT[r]
#define _XY_TO_RC(x, y) XY_TO_RIGHT_COUNT[x][y]
#define _generRC(_1, _2, __, ...) __
#define getRightCount(...) INDIRECT_EXPAND(_generRC, (__VA_ARGS__, _XY_TO_RC, _R_TO_RC, ...)(__VA_ARGS__))
...
#define INIT(...) INDIRECT_EXPAND(_generInit, (__VA_ARGS__, _init_M_A3_3, _init_M_A3_2, _init_M_P4, _init_M, ...)(__VA_ARGS__))
