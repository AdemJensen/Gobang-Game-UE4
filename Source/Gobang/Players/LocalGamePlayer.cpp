...
void ALocalGamePlayer::AiTimerTask()
{
...
void ALocalGamePlayer::StartHintCalculation()
{
	Worker->Start();
	AiTimerDelegate = FTimerDelegate::CreateUObject(this, &ALocalGamePlayer::AiTimerTask);
...
void ALocalGamePlayer::DoRoundOver(FIntPoint ActionLocation)
{
	if (bAiRunning)
	{
		Worker->End();
